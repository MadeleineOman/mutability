...
# - lab method: 
#     - H3k4me3 Chip-seq. read more on general histone Chip seq:: http://genome.ucsc.edu/cgi-bin/hgFileUi?db=hg18&g=wgEncodeBroadChipSeq
# - file format & head: 
#     - wig format 
...
#download the files 
wget http://hgdownload.soe.ucsc.edu/goldenPath/hg18/encodeDCC/wgEncodeBroadChipSeq/wgEncodeBroadChipSeqSignalGm12878H3k4me3.wig.gz -P data/blood/track_data/H3k4me3/
...
gunzip data/blood/track_data/H3k4me3/wgEncodeBroadChipSeqSignalGm12878H3k4me3.wig.gz
wig2bed --multisplit < data/blood/track_data/H3k4me3/wgEncodeBroadChipSeqSignalGm12878H3k4me3.wig > data/blood/track_data/H3k4me3/wgEncodeBroadChipSeqSignalGm12878H3k4me3.bed

#tabix big file 
bgzip data/blood/track_data/H3k4me3/wgEncodeBroadChipSeqSignalGm12878H3k4me3.bed
tabix -s 1 -b 2 -e 3 data/blood/track_data/H3k4me3/wgEncodeBroadChipSeqSignalGm12878H3k4me3.bed.gz
...
do 
tabix data/blood/track_data/H3k4me3/wgEncodeBroadChipSeqSignalGm12878H3k4me3.bed.gz $f > data/blood/track_data/H3k4me3/H3k4me3_$f.bed
bgzip data/blood/track_data/H3k4me3/H3k4me3_$f.bed
tabix -s 1 -b 2 -e 3 data/blood/track_data/H3k4me3/H3k4me3_$f.bed.gz
done